...
{{/*
Generate default certificate for ingress
*/}}
{{- define "nginx-ingress.gen-certs" -}}
{{- $ca := genCA "nginx-ingress-ca" 365 -}}
...
*/}}
{{- define "nginx-ingress.defaultTLSSecret.fullname" -}}
{{- printf "%s-%s" (include "nginx-ingress.fullname" .) "default-cert" | trunc 63 | trimSuffix "-" -}}
{{- end -}}
