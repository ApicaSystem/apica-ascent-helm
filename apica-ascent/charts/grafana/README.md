...
| `global.environment.admin_name`                                         | Grafana admin username                                                                                                                                                                                                                | `admin`                                                 |
| `global.environment.admin_password`                                     | Grafana admin password                                                                                                                                                                                                                | Randomly generated                                      |
...
$ helm install my-release \
  --set global.environment.admin_name=admin-user bitnami/grafana
```
